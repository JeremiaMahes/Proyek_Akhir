...
<head>
    ...
    <title>Input Police Data</title>
</head>
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-light">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3 fw-bold" href="{{ url('dashboard') }}">Kepolisian Indonesia</a>
        <!-- Sidebar Toggle-->
            ...
            <main>
                <div class="container mt-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{url('kirim-dosen')}}">
                            @csrf
                                <div class="form-group">
                                    <label for="nidn">NIP</label>
                                    <input type="text" id="nidn" name="nidn" class="form-control @error('nidn') is-invalid @enderror"  value="{{ old('nidn') }}">
                                    @error('nidn')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_kelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror" >{{ old('jenis_kelamin') }}>
                                ...
                                <div class="form-group">
                                    <label for="pendidikan_terakhir">Position</label>
                                    <input type="text" id="pendidikan_terakhir" name="pendidikan_terakhir" class="form-control @error('pendidikan_terakhir') is-invalid @enderror"  value="{{ old('pendidikan_terakhir') }}">
                                ...
                                <div class="form-group">
                                    <label for="fakultas">City</label>
                                    <input type="text" id="fakultas" name="fakultas" class="form-control @error('fakultas') is-invalid @enderror"  value="{{ old('fakultas') }}">
                                    @error('fakultas')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
