...
class DosenController extends Controller
{
    ...
    public function input(Request $request){
        ...
        return redirect('tampil-dosen')->with('status', 'Police data has been added');
    }
    public function delete($nidn){
        $model = Dosen::find($nidn);
        $model->delete();
        return redirect('tampil-dosen')->with('status-deleted','Police data has been deleted');
    }
    ...
    public function update(Request $request, $nidn){
        ...
        return redirect('tampil-dosen')->with('status', 'Police data has been updated');
    }
}
