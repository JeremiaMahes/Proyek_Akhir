...
class TugasController extends Controller
{
    ...
    public function input(Request $request){
        ...
        return redirect('tampil-tugas')->with('status', 'Finished case has been added');
    }
    ...
    public function delete($id){
        $model = Tugas::find($id);
        $model->delete();
        return redirect('tampil-tugas')->with('status-deleted','Finished case has been deleted');
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect('tampil-tugas')->with('status', 'Finished case has been updated');
    }
}
